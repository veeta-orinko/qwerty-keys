...
const bass = new Tone.MembraneSynth().chain(distortion, reverb, delay, chorus, phaser, tremolo);
// More synths or samples...

export { synth, bass, distortion, reverb, delay, chorus, phaser, tremolo };
